#include "com_daoran_newfactory_onefactory_util_bsdiff_DiffUtils.h"
...
JNIEXPORT jint JNICALL Java_com_daoran_newfactory_onefactory_util_bsdiff_DiffUtils_genDiff(JNIEnv *env,
