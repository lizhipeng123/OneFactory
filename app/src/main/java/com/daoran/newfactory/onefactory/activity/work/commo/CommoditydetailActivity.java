...
public class CommoditydetailActivity extends Activity
            ...
            tv_commodetail_sealedrev.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final DatePickerDialog datePickerDialog = new DatePickerDialog(
                            CommoditydetailActivity.this, null,
    ...
    private void setSaveDate() {
        if (NetWork.isNetWorkAvailable(this)) {
            ...
            String commodetailchkfctdt = sp.getString("commodetailchkfctdt", "");//实际件查时间
            String commodetailchkplace = sp.getString("commodetailchkplace", "");//件查地址
            List<CommoditySaveBean.DataBean> commoditySaveBean =
                    new ArrayList<CommoditySaveBean.DataBean>();
            CommoditySaveBean saveBean = new CommoditySaveBean();
            CommoditySaveBean.DataBean dataBean = new CommoditySaveBean.DataBean();
            ...
            if (commonulltitle.equals("1") && commonullitem.equals("1") && commonullsearledrev.equals("1")
                ...
                ToastUtils.ShowToastMessage("未修改表中数据", CommoditydetailActivity.this);
                ...
                OkHttpUtils.postString()
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onError(Call call, Exception e, int id) {
                                e.printStackTrace();
                                ToastUtils.ShowToastMessage("数据错误，请重新输入", CommoditydetailActivity.this);
                            }
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                if (ression.equals("true")) {
                                    CommoditySqlActivity.instance.finish();
                                    ToastUtils.ShowToastMessage("保存成功",
                                            CommoditydetailActivity.this);
                                    startActivity(new Intent(CommoditydetailActivity.this,
                                            CommoditySqlActivity.class));
                                    finish();
                                } else {
