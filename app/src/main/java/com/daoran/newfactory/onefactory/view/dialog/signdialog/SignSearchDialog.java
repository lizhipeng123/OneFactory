package com.daoran.newfactory.onefactory.view.dialog.signdialog;
...
public class SignSearchDialog extends Dialog {
    Activity content;
    ...
    public SignSearchDialog(Context context) {
        super(context);
    }

    public SignSearchDialog(Activity context, int theme, View.OnClickListener clickListener, View.OnClickListener mCancleLinstener) {
        super(context, theme);
