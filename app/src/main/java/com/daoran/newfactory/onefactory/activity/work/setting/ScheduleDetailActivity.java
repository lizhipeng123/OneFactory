...
import com.daoran.newfactory.onefactory.util.file.date.DateUtils;
import com.daoran.newfactory.onefactory.util.file.date.JeekUtils;
import com.daoran.newfactory.onefactory.util.task.eventset.LoadEventSetMapTask;
import com.daoran.newfactory.onefactory.util.task.schedule.UpdateScheduleTask;
import com.daoran.newfactory.onefactory.view.dialog.settingdialog.InputLocationDialog;
import com.daoran.newfactory.onefactory.view.dialog.settingdialog.SelectDateDialog;
import com.daoran.newfactory.onefactory.view.dialog.settingdialog.SelectEventSetDialog;
...
public class ScheduleDetailActivity extends BaseActivity implements View.OnClickListener, OnTaskFinishedListener<Map<Integer, EventSet>>, SelectDateDialog.OnSelectDateListener, InputLocationDialog.OnLocationBackListener, SelectEventSetDialog.OnSelectEventSetListener {
    ...
    private void setScheduleData() {
        ...
        ivScheduleEventSetIcon.setImageResource(mSchedule.getEventSetId() == 0 ?
                R.mipmap.ic_detail_category : R.mipmap.ic_detail_icon);
        ...
        if (requestCode == SelectEventSetDialog.ADD_EVENT_SET_CODE) {
            if (resultCode == AddEventSetActivity.ADD_EVENT_SET_FINISH) {
                ...
                if (eventSet != null) {
                    ...
                    sendBroadcast(new Intent(MonthActivity.ADD_EVENT_SET_ACTION).putExtra(AddEventSetActivity.EVENT_SET_OBJ, eventSet));
                }
            }
        }
    }
