...
public class MonthActivity extends BaseUIActivity
        implements View.OnClickListener, OnTaskFinishedListener<List<EventSet>> {
    ...
    protected void bindView() {
        ...
        searchViewById(R.id.ivBack).setOnClickListener(this);
            ...
            if (ADD_EVENT_SET_ACTION.equals(intent.getAction())) {
                EventSet eventSet = (EventSet)
                        intent.getSerializableExtra
                                (AddEventSetActivity.EVENT_SET_OBJ);
                if (eventSet != null)
