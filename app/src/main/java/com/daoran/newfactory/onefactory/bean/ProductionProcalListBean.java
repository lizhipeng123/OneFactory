...
public class ProductionProcalListBean {
    private List<ProductionProcalListBean.Data> datas;

    public List<ProductionProcalListBean.Data> getDatas() {
        return datas;
    }

    public void setDatas(List<ProductionProcalListBean.Data> datas) {
        this.datas = datas;
    }
