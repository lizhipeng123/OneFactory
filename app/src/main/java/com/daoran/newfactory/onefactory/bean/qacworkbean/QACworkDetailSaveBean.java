...
public class QACworkDetailSaveBean {
    private int totalCount;
    private List<QACworkPageDataBean.DataBean> Data;
    ...
    public List<QACworkPageDataBean.DataBean> getData() {
        return Data;
    }

    public void setData(List<QACworkPageDataBean.DataBean> Data) {
        this.Data = Data;
    }
