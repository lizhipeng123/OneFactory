...
public class CommoditySaveBean {
    private int totalCount;
    private List<CommoditydetailBean.DataBean> Data;
    ...
    public List<CommoditydetailBean.DataBean> getData() {
        return Data;
    }

    public void setData(List<CommoditydetailBean.DataBean> Data) {
        this.Data = Data;
    }
